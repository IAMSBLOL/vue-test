...
export function deleteContentAfterAtSign(range) {
	const startContainer = range.startContainer
	const startOffset = range.startOffset
...
export function setSelectionStartByEle(start) {
	// 新光标
...
export function insertMention(range, mentionText, value, split, mentionClass) {
	...
	mentionNode.setAttribute('data-id', value)
	mentionNode.setAttribute('data-name', mentionText)
...
export function insertText(range, text) {
